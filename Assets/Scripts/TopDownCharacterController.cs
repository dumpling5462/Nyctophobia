...
public class TopDownCharacterController : MonoBehaviour
{
    ...
    [SerializeField] float playerSprintSpeedMultiplier;
    #endregion
    ...
    [SerializeField] int ProjectileWeaponAttackSpeed;
    #endregion 
    /// <summary>
    ...
    private void FixedUpdate()
    {
        ...
        {
            rb.velocity = playerDirection * (playerSpeed * (playerMaxSpeed * playerSprintSpeedMultiplier)) * Time.fixedDeltaTime;
        }
        else
        {
